...
//        junitText2(start, EVERY_PAGE_COUNT, null);
    ...
    private void junitText2(int s, int c, final RefreshLayout refreshLayout) {
...
//        如果是下拉并且没有size>total没有数据了就生成吐司并返回
        ...
        Observable<HotMovie> observable = apiService.getHotMovieUserRxjava(city, s, c);
        ...
        public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, int i) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("movieImageUrl", subject.images.large);
